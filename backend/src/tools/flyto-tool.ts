...
import { buildDescribedSchema, DEFAULT_FLY_TO_FIELD_DESCRIPTIONS } from "@cesium-ai/tools-schemas";
 ...
 * via the same {@link buildDescribedSchema} helper `@cesium-ai/tools-schemas`
