...
| **Logging**                | [`@cesium-ai/observability`](../../packages/observability/)                                                                                                                                     | Canonical `Logger`, `noopLogger`, and `createConsoleLogger`. Logs every discovered tool's name + description at connect time when configured.                                                                                                                            |
