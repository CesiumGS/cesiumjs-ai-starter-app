...
vi.mock("ai", () => ({
  ...
  // The real `Output.object` builds an AI SDK output strategy; the source only threads its
  // `schema` option through opaquely, so a passthrough stand-in is enough for these tests.
