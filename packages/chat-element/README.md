...
| `logger`             | `Logger` from `@cesium-ai/observability`                                                        | —                     | Structured logger for stream/tool/approval errors the underlying `ChatClient` encounters. Errors always still reach the transcript regardless of whether this is set.                                                                                                                  |
