...
| `logger`             | `ChatLogger`                                                                                    | —                     | Structured logger for stream/tool/approval errors the underlying `ChatClient` encounters (e.g. wire it into your app's own OTEL telemetry). Errors always still reach the transcript regardless of whether this is set.                                                               |
