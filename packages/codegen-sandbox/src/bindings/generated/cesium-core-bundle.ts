...
${this.stack.toString()}`;
    ...
    Check.typeOf.func = function (name, test) {
      if (typeof test !== "function") {
        throw new DeveloperError_default(getFailedTypeErrorMessage(typeof test, "function", name));
      }
    };
    Check.typeOf.string = function (name, test) {
      if (typeof test !== "string") {
        throw new DeveloperError_default(getFailedTypeErrorMessage(typeof test, "string", name));
      }
    };
    Check.typeOf.number = function (name, test) {
      if (typeof test !== "number") {
        throw new DeveloperError_default(getFailedTypeErrorMessage(typeof test, "number", name));
      }
    };
    ...
    Check.typeOf.object = function (name, test) {
      if (typeof test !== "object") {
        throw new DeveloperError_default(getFailedTypeErrorMessage(typeof test, "object", name));
      }
    };
    Check.typeOf.bool = function (name, test) {
      if (typeof test !== "boolean") {
        throw new DeveloperError_default(getFailedTypeErrorMessage(typeof test, "boolean", name));
      }
    };
    Check.typeOf.bigint = function (name, test) {
      if (typeof test !== "bigint") {
        throw new DeveloperError_default(getFailedTypeErrorMessage(typeof test, "bigint", name));
      }
    };
    ...
    CesiumMath.toSNorm = function (value, rangeMaximum) {
      ...
      return Math.round((CesiumMath.clamp(value, -1, 1) * 0.5 + 0.5) * rangeMaximum);
    };
    ...
    CesiumMath.factorial = function (n) {
      if (typeof n !== "number" || n < 0) {
        throw new DeveloperError_default("A number greater than or equal to 0 is required.");
      }
    ...
    var Cartesian2 = class _Cartesian2 {
      ...
      static angleBetween(left, right) {
        ...
        return Math_default.acosClamped(_Cartesian2.dot(angleBetweenScratch, angleBetweenScratch2));
      }
      /**
      ...
      static equalsEpsilon(left, right, relativeEpsilon, absoluteEpsilon) {
        return (
          ...
          (defined_default(left) &&
            defined_default(right) &&
            Math_default.equalsEpsilon(left.x, right.x, relativeEpsilon, absoluteEpsilon) &&
            Math_default.equalsEpsilon(left.y, right.y, relativeEpsilon, absoluteEpsilon))
        );
      }
      /**
      ...
      equalsEpsilon(right, relativeEpsilon, absoluteEpsilon) {
        return _Cartesian2.equalsEpsilon(this, right, relativeEpsilon, absoluteEpsilon);
      }
      /**
    ...
    var Cartesian3 = class _Cartesian3 {
      ...
      static angleBetween(left, right) {
        ...
        const sine = _Cartesian3.magnitude(
          _Cartesian3.cross(angleBetweenScratch3, angleBetweenScratch22, angleBetweenScratch3),
        );
      ...
      static equalsEpsilon(left, right, relativeEpsilon, absoluteEpsilon) {
        return (
          ...
          (defined_default(left) &&
            ...
            Math_default.equalsEpsilon(left.x, right.x, relativeEpsilon, absoluteEpsilon) &&
            Math_default.equalsEpsilon(left.y, right.y, relativeEpsilon, absoluteEpsilon) &&
            Math_default.equalsEpsilon(left.z, right.z, relativeEpsilon, absoluteEpsilon))
        );
      }
      /**
      ...
      static fromDegrees(longitude, latitude, height, ellipsoid, result) {
        ...
        return _Cartesian3.fromRadians(longitude, latitude, height, ellipsoid, result);
      }
      /**
      ...
      static fromRadians(longitude, latitude, height, ellipsoid, result) {
        ...
        const radiiSquared = !defined_default(ellipsoid)
          ? _Cartesian3._ellipsoidRadiiSquared
      ...
      static fromDegreesArray(coordinates, ellipsoid, result) {
        ...
        for (let i = 0; i < length; i += 2) {
          ...
          const index = i / 2;
          result[index] = _Cartesian3.fromDegrees(longitude, latitude, 0, ellipsoid, result[index]);
        }
        return result;
      }
      /**
      ...
      static fromRadiansArray(coordinates, ellipsoid, result) {
        ...
        for (let i = 0; i < length; i += 2) {
          ...
          const latitude = coordinates[i + 1];
          const index = i / 2;
          result[index] = _Cartesian3.fromRadians(longitude, latitude, 0, ellipsoid, result[index]);
        }
        return result;
      }
      /**
       ...
       */
      equalsEpsilon(right, relativeEpsilon, absoluteEpsilon) {
        return _Cartesian3.equalsEpsilon(this, right, relativeEpsilon, absoluteEpsilon);
      }
      /**
    ...
    function scaleToGeodeticSurface(
      ...
      let lambda =
        ((1 - ratio) * Cartesian3_default.magnitude(cartesian)) /
        (0.5 * Cartesian3_default.magnitude(gradient));
      let correction = 0;
      let func;
      let denominator;
      let xMultiplier;
    ...
    var Cartographic = class _Cartographic {
      ...
      static fromCartesian(cartesian, ellipsoid, result) {
        const oneOverRadii = defined_default(ellipsoid)
          ? ellipsoid.oneOverRadii
          : _Cartographic._ellipsoidOneOverRadii;
        const oneOverRadiiSquared = defined_default(ellipsoid)
          ? ellipsoid.oneOverRadiiSquared
          : _Cartographic._ellipsoidOneOverRadiiSquared;
        const centerToleranceSquared = defined_default(ellipsoid)
          ? ellipsoid._centerToleranceSquared
          : _Cartographic._ellipsoidCenterToleranceSquared;
        ...
        const height =
          Math_default.sign(Cartesian3_default.dot(h, cartesian)) * Cartesian3_default.magnitude(h);
        if (!defined_default(result)) {
          return new _Cartographic(longitude, latitude, height);
        }
        result.longitude = longitude;
    ...
    function supportsPointerEvents() {
      if (!defined_default(hasPointerEvents)) {
        hasPointerEvents =
          ...
          (!defined_default(theNavigator.pointerEnabled) || theNavigator.pointerEnabled);
      }
    ...
    var Color = class _Color {
      ...
      static fromRandom(options, result) {
        ...
        if (!defined_default(green)) {
          ...
          Check_default.typeOf.number.lessThanOrEquals("minimumGreen", minimumGreen, maximumGreen);
        ...
        if (!defined_default(blue)) {
          ...
          Check_default.typeOf.number.lessThanOrEquals("minimumBlue", minimumBlue, maximumBlue);
        ...
        if (!defined_default(alpha)) {
          ...
          Check_default.typeOf.number.lessThanOrEquals("minimumAlpha", minimumAlpha, maximumAlpha);
    ...
    HeadingPitchRoll.equalsEpsilon = function (left, right, relativeEpsilon, absoluteEpsilon) {
      return (
        ...
        (defined_default(left) &&
          ...
          Math_default.equalsEpsilon(left.pitch, right.pitch, relativeEpsilon, absoluteEpsilon) &&
          Math_default.equalsEpsilon(left.roll, right.roll, relativeEpsilon, absoluteEpsilon))
      );
    };
