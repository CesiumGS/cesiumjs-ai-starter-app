...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`cesium-capabilities.json`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/cesium-capabilities.json) (package root)               | Single reviewed policy manifest: Cesium version, blocked static exports, guest value types, blocked properties, dynamic Promise coverage, unsupported capabilities.        |
| [`capabilities-registry.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/bindings/capabilities-registry.ts)                 | Typed runtime view of `cesium-capabilities.json`; binding modules derive their sets/names from this.                                                                       |
| [`sandbox-handles.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/bindings/sandbox-handles.ts)                             | `SandboxHandles`: the core JSON marshaling boundary — opaque handle ids for class instances, transparent value types, rejects forged handle ids.                           |
| [`guarded-viewer-proxy.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/bindings/guarded-viewer-proxy.ts)                   | `createProxiedViewer`/`createGuardedProxy`: wraps the real `Viewer` (and nested `camera`/`scene`/`entities`/`dataSources`) so cap checks and the property allowlist apply. |
| [`guest-prelude-host-bridge.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/bindings/guest-prelude-host-bridge.ts)         | Builds the guest-side `__remoteProxy__` — the recursive `Proxy` dispatching reads/writes/calls/`new` to the four bridge functions above.                                   |
| [`guest-prelude-static-fallback.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/bindings/guest-prelude-static-fallback.ts) | Upgrades the guest's `Cesium` namespace into a `Proxy` falling back to non-blocked static Cesium exports through the same bridge.                                          |
| [`guest-prelude-value-types.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/bindings/guest-prelude-value-types.ts)         | Reimplements the most common pure value types (`Cartesian2`/`3`, `Color`, `Cartographic`, `HeadingPitchRange`/`Roll`, `NearFarScalar`) directly in guest JS.               |
| [`generated/value-type-registry.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/bindings/generated/value-type-registry.ts) | Generated constructor/field metadata from `cesium-capabilities.json`; regenerate with `npm run generate:value-type-registry -w @cesium-ai/codegen-sandbox`.                |
| [`function-source.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/bindings/function-source.ts)                             | `extractFunctionBody` — lets guest-prelude "body" functions be real, type-checked TypeScript with their source extracted for injection, not raw template literals.         |
| [`execution-guards.ts`](https://github.com/CesiumGS/cesiumjs-ai-starter-app/blob/main/packages/codegen-sandbox/src/execution-guards.ts) (package root)                     | Client-side defense-in-depth caps (`assertEntityCapNotExceeded`, `assertCollectionCapNotExceeded`), independent of process isolation and static verification.              |
