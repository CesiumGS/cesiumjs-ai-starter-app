...
export const DEFAULT_ENTITY_ADD_CYLINDER_DESCRIPTION = "Add a cylinder or cone entity, useful for towers, pillars, or volumetric structures.";
 ...
 */
export function buildEntityAddCylinderInputSchema(descriptions: EntityAddCylinderFieldDescriptions = {}) {
 ...
 */
export const createEntityAddCylinder = createToolFactory(DEFAULT_ENTITY_ADD_CYLINDER_DESCRIPTION, buildEntityAddCylinderInputSchema);
