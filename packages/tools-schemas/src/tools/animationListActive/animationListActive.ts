...
export const DEFAULT_ANIMATION_LIST_ACTIVE_DESCRIPTION = "List all active animations with their current playback state and the shared clock state.";
 ...
 */
export function buildAnimationListActiveInputSchema(descriptions: AnimationListActiveFieldDescriptions = {}) {
 ...
 */
export const createAnimationListActive = createToolFactory(DEFAULT_ANIMATION_LIST_ACTIVE_DESCRIPTION, buildAnimationListActiveInputSchema);
