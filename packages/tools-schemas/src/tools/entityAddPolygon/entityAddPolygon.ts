...
export const DEFAULT_ENTITY_ADD_POLYGON_DESCRIPTION = "Add a filled polygon area entity, useful for boundaries, zones, or regions.";
 ...
 */
export function buildEntityAddPolygonInputSchema(descriptions: EntityAddPolygonFieldDescriptions = {}) {
 ...
 */
export const createEntityAddPolygon = createToolFactory(DEFAULT_ENTITY_ADD_POLYGON_DESCRIPTION, buildEntityAddPolygonInputSchema);
