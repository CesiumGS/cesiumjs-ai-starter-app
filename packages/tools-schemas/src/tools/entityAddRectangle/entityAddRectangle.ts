...
export const DEFAULT_ENTITY_ADD_RECTANGLE_DESCRIPTION = "Add a rectangle entity defined by geographic bounds, useful for regions or bounding boxes.";
 ...
 */
export function buildEntityAddRectangleInputSchema(descriptions: EntityAddRectangleFieldDescriptions = {}) {
 ...
 */
export const createEntityAddRectangle = createToolFactory(DEFAULT_ENTITY_ADD_RECTANGLE_DESCRIPTION, buildEntityAddRectangleInputSchema);
