...
export const DEFAULT_CAMERA_STOP_ORBIT_DESCRIPTION =
  "Stop any active automated camera orbit and return the camera to manual navigation.";
 ...
 */
export function buildCameraStopOrbitInputSchema(
  descriptions: CameraStopOrbitFieldDescriptions = {},
) {
 ...
 */
export const createCameraStopOrbit = createToolFactory(
