...
export const DEFAULT_CAMERA_LOOK_AT_TRANSFORM_DESCRIPTION = "Lock the camera to look at a fixed target point on the globe, useful for inspecting a landmark or setting up an orbit. Pair with cameraStartOrbit to begin an automated orbit around this target.";
 ...
 */
export function buildCameraLookAtTransformInputSchema(descriptions: CameraLookAtTransformFieldDescriptions = {}) {
 ...
 */
export const createCameraLookAtTransform = createToolFactory(DEFAULT_CAMERA_LOOK_AT_TRANSFORM_DESCRIPTION, buildCameraLookAtTransformInputSchema);
