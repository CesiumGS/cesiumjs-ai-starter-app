...
export const DEFAULT_ENTITY_ADD_WALL_DESCRIPTION = "Add a vertical wall entity from a series of positions, useful for barriers or fences.";
 ...
 */
export const createEntityAddWall = createToolFactory(DEFAULT_ENTITY_ADD_WALL_DESCRIPTION, buildEntityAddWallInputSchema);
