...
export const DEFAULT_CAMERA_GET_POSITION_DESCRIPTION = "Get the current camera position, orientation, and visible view rectangle. Use to answer questions about where the camera currently is.";
 ...
 */
export function buildCameraGetPositionInputSchema(descriptions: CameraGetPositionFieldDescriptions = {}) {
 ...
 */
export const createCameraGetPosition = createToolFactory(DEFAULT_CAMERA_GET_POSITION_DESCRIPTION, buildCameraGetPositionInputSchema);
