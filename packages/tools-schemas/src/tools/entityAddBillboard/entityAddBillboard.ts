...
export const DEFAULT_ENTITY_ADD_BILLBOARD_DESCRIPTION =
  "Add an image/icon billboard entity that always faces the camera.";
 ...
 */
export function buildEntityAddBillboardInputSchema(
  descriptions: EntityAddBillboardFieldDescriptions = {},
) {
 ...
 */
export const createEntityAddBillboard = createToolFactory(
