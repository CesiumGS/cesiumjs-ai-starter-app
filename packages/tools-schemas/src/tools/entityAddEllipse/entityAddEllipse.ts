...
export const DEFAULT_ENTITY_ADD_ELLIPSE_DESCRIPTION =
  "Add an ellipse entity, useful for circular areas, zones, or coverage regions.";
 ...
 */
export function buildEntityAddEllipseInputSchema(
  descriptions: EntityAddEllipseFieldDescriptions = {},
) {
 ...
 */
export const createEntityAddEllipse = createToolFactory(
