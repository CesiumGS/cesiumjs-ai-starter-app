...
export const DEFAULT_ANIMATION_CONTROL_DESCRIPTION =
  "Play or pause a specific animation's playback.";
 ...
 */
export function buildAnimationControlInputSchema(
  descriptions: AnimationControlFieldDescriptions = {},
) {
 ...
 */
export const createAnimationControl = createToolFactory(
