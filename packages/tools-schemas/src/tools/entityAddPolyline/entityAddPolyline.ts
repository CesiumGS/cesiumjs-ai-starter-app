...
export const DEFAULT_ENTITY_ADD_POLYLINE_DESCRIPTION = "Add a polyline path entity connecting multiple points, useful for routes or boundaries.";
 ...
 */
export function buildEntityAddPolylineInputSchema(descriptions: EntityAddPolylineFieldDescriptions = {}) {
 ...
 */
export const createEntityAddPolyline = createToolFactory(DEFAULT_ENTITY_ADD_POLYLINE_DESCRIPTION, buildEntityAddPolylineInputSchema);
