...
export const DEFAULT_ANIMATION_CAMERA_TRACKING_DESCRIPTION =
  "Make the camera follow a specific animated entity, or stop tracking to restore free camera control.";
 ...
 */
export function buildAnimationCameraTrackingInputSchema(
  descriptions: AnimationCameraTrackingFieldDescriptions = {},
) {
...
export type AnimationCameraTrackingConfig =
  ClientToolConfig<AnimationCameraTrackingFieldDescriptions>;
 ...
 */
export const createAnimationCameraTracking = createToolFactory(
