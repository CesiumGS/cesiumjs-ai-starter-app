...
export const DEFAULT_ANIMATION_CREATE_DESCRIPTION =
  "Create an animated 3D model entity that moves along a path defined by explicit position samples with timestamps.";
...
export const DEFAULT_ANIMATION_CREATE_FIELD_DESCRIPTIONS: Required<AnimationCreateFieldDescriptions> =
  {
    positionSamples:
      "Array of position samples, each with an ISO 8601 timestamp plus longitude, latitude, and optional height.",
 ...
 */
export function buildAnimationCreateInputSchema(
  descriptions: AnimationCreateFieldDescriptions = {},
) {
 ...
 */
export const createAnimationCreate = createToolFactory(
