...
export const DEFAULT_CAMERA_SET_CONTROLLER_OPTIONS_DESCRIPTION =
  "Configure camera movement constraints and controller behaviour: enable or disable rotate/pan/zoom/tilt/look, set zoom distance limits, and toggle collision detection.";
 ...
 */
export function buildCameraSetControllerOptionsInputSchema(
  descriptions: CameraSetControllerOptionsFieldDescriptions = {},
) {
...
export const defaultCameraSetControllerOptionsInputSchema =
  buildCameraSetControllerOptionsInputSchema();

/** Per-tool overrides for {@link createCameraSetControllerOptions}. */
export type CameraSetControllerOptionsConfig =
  ClientToolConfig<CameraSetControllerOptionsFieldDescriptions>;
 ...
 */
export const createCameraSetControllerOptions = createToolFactory(
