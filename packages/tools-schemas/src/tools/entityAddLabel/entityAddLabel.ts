...
export const DEFAULT_ENTITY_ADD_LABEL_DESCRIPTION =
  "Add a 3D text label entity at a location on the globe.";
 ...
 */
export const createEntityAddLabel = createToolFactory(
