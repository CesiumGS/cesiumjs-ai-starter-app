...
export const DEFAULT_ANIMATION_REMOVE_DESCRIPTION =
  "Remove an animated entity from the scene and stop tracking it.";
 ...
 */
export function buildAnimationRemoveInputSchema(
  descriptions: AnimationRemoveFieldDescriptions = {},
) {
 ...
 */
export const createAnimationRemove = createToolFactory(
