...
export const DEFAULT_ANIMATION_UPDATE_PATH_DESCRIPTION =
  "Update the visual appearance of an animation's path trail without recreating the animation.";
 ...
 */
export function buildAnimationUpdatePathInputSchema(
  descriptions: AnimationUpdatePathFieldDescriptions = {},
) {
 ...
 */
export const createAnimationUpdatePath = createToolFactory(
