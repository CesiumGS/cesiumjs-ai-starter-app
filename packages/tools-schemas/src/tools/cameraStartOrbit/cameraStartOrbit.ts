...
export const DEFAULT_CAMERA_START_ORBIT_DESCRIPTION =
  "Start an automated circular orbit of the camera around the current look-at target (set via cameraLookAtTransform).";
 ...
 */
export function buildCameraStartOrbitInputSchema(
  descriptions: CameraStartOrbitFieldDescriptions = {},
) {
 ...
 */
export const createCameraStartOrbit = createToolFactory(
