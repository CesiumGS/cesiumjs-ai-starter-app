...
export const DEFAULT_ENTITY_ADD_MODEL_DESCRIPTION = "Add a 3D model (GLTF/GLB) entity at a location on the globe. The `uri` must be a valid URL — ask the user for their model URL or use a publicly available model.";
 ...
 */
export const createEntityAddModel = createToolFactory(DEFAULT_ENTITY_ADD_MODEL_DESCRIPTION, buildEntityAddModelInputSchema);
