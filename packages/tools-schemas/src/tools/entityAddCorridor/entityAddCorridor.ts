...
export const DEFAULT_ENTITY_ADD_CORRIDOR_DESCRIPTION = "Add a corridor entity along a path with a fixed width, useful for roads, pipelines, or routes.";
 ...
 */
export function buildEntityAddCorridorInputSchema(descriptions: EntityAddCorridorFieldDescriptions = {}) {
 ...
 */
export const createEntityAddCorridor = createToolFactory(DEFAULT_ENTITY_ADD_CORRIDOR_DESCRIPTION, buildEntityAddCorridorInputSchema);
