...
export const CESIUM_TOOL_NAMES = {
  ...
  cameraStartOrbit: "cameraStartOrbit",
  cameraStopOrbit: "cameraStopOrbit",
  cameraGetPosition: "cameraGetPosition",
  cameraSetControllerOptions: "cameraSetControllerOptions",
  // entity
  entityAddPoint: "entityAddPoint",
  entityAddBillboard: "entityAddBillboard",
  entityAddLabel: "entityAddLabel",
  entityAddModel: "entityAddModel",
  entityAddPolygon: "entityAddPolygon",
  entityAddPolyline: "entityAddPolyline",
  entityAddBox: "entityAddBox",
  entityAddCorridor: "entityAddCorridor",
  entityAddCylinder: "entityAddCylinder",
  entityAddEllipse: "entityAddEllipse",
  entityAddRectangle: "entityAddRectangle",
  entityAddWall: "entityAddWall",
